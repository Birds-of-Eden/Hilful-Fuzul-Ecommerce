        ...
        <>
          ...
          <div className="bg-white/90 backdrop-blur-sm border border-[#D1D8BE] rounded-2xl shadow-lg p-4">
            <p className="text-sm text-[#2D4A3C]/70">
              Showing {((page - 1) * 12) + 1} to {Math.min(page * 12, totalCount)} of {totalCount} blogs
                  ...
                  {blog.image ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#EEEFE0] to-[#D1D8BE] flex items-center justify-center">
                      <svg className="w-12 h-12 text-[#819A91]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2m0-1h.01" />
                      </svg>
                    </div>
                  )}
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-[#D1D8BE] rounded-2xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              {page < totalPages - 2 && (
                <>
                  {page < totalPages - 3 && <span className="text-[#2D4A3C]/50">...</span>}
                  <button
